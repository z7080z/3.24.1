...
public:
  ...
  virtual void StartRx (Ptr<SpectrumSignalParameters> params);
	...
	//Ubines
	Time CalculateGTSTxTime (uint32_t);
	//end Ubines
  ...
  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //added by Ubines, 20131215
  //getter and setter for channel number variable / to calcalte GTS slot base on packetSize / Direct transmission
  void SetChannelNumber (uint32_t channel_number);
